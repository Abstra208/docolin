<script lang="ts">
  ...
  // overlap.
  //
  // The search input lives at the page level (not here) so it stays visible
  // during loading; this component just consumes the query string and
  // filters. messages is already the per-user fetched payload; query is
  // page-controlled.
